...
An interactive parallel sets visualisation for D3.
...
<a name="d3_parsets" href="#wiki-d3_parsets">#</a> d3.<b>parsets</b>()
...
<a name="parsets_dimensions" href="#wiki-parsets_dimensions">#</a> parsets.<b>dimensions</b>(<i>dimensions</i>)
...
<a name="parsets_value" href="#wiki-parsets_value">#</a> parsets.<b>value</b>(<i>value</i>)
...
<a name="parsets_width" href="#wiki-parsets_width">#</a> parsets.<b>width</b>(<i>width</i>)

<p>Specifies the chart width in pixels. If *width* is not specified, returns the current width, which defaults to 960.

<a name="parsets_height" href="#wiki-parsets_height">#</a> parsets.<b>height</b>(<i>height</i>)

<p>Specifies the chart height in pixels. If *height* is not specified, returns the current height, which defaults to 600.

<a name="parsets_spacing" href="#wiki-parsets_spacing">#</a> parsets.<b>spacing</b>(<i>spacing</i>)
...
<a name="parsets_tension" href="#wiki-parsets_tension">#</a> parsets.<b>tension</b>(<i>tension</i>)
...
<a name="parsets_duration" href="#wiki-parsets_duration">#</a> parsets.<b>duration</b>(<i>duration</i>)
